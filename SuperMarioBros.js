...
Super Mario Bros La Pelicula (en ingles:/)

[Film begins with the short version of the 2013 Universal Pictures logo, then the Illumination logo: Stuart the Minion is in a go-kart, preparing for a race, with a red lights on the letters "ILLUMINATION", then turns green, then white. The engine stalls, as the releases the brake, then hits the engine, and the go-kart speeds faster.]

STUART: [screaming] Illumination!

[Then resumes with the Nintendo logo. A kingdom of snow and ice is seen in the distance. Suddenly, magma drops upon the ice. A floating castle constructed of rock and lava with a monstrous figurehead in front flies toward the ice kingdom. It drops anchor and lands, opening its gates to release an army of turtle-like Koopas. At a higher level of the castle, winged Koopa Paratroopas take flight, to join their non-flying bretheren in ranks that form a path leading to the head of the castle. A blue-robed Koopa magician, Kamek, appears from thin air.]

KAMEK: Behold! The King of the Koopas!

[Kamek strikes his wand upon the ground, signaling the Koopa army to turn in attention as their monstrous leader, Bowser, emerges. Bowser walks toward the ice castle. One Koopa Troopa is shown shivering in their shell out of nerves.]
...
("Whatever those things are" referring to a pair of Spinies, quadruped turtles with red shells, that have silver spikes)
...
[Mario enters the ring, full of cheering Kongs, who then boo at Mario's presence. Suddenly, Donkey Kong emerges, much to the adoration of the crowd. The "DK Rap" from Donkey Kong 64 begins to play. He crushes two barrels that come out of nowhere.]
